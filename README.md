Este projeto consiste numa simulação de uma aplicação de solicitação de um reboque em caso de emergência (semelhante à aplicação de prestação de serviços rodoviários da companhia de seguros Fidelidade)
